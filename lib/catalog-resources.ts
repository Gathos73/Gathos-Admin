...
export const CATALOG_CONFIGS: Record<"products" | "plans" | "plan_limits" | "product_routes", ResourceConfig> = {
  ...
  plans: {
    ...
    fields: [{ ...code, placeholder: "e.g. creator_custom", help: "Unique plan identifier using lowercase letters, numbers and underscores. Cannot be changed after creation." },
      ...
      { name: "billing_provider", label: "Billing provider", kind: "select", nullable: true, options: [option("gathos"), option("dodo")], help: "Choose gathos for internal billing or dodo for Dodo payments. Set to dodo automatically if you confirm Dodo product creation when saving a new plan." },
