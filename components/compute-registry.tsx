      ...
      <fieldset disabled={disabled}>
        <section className="compute-form-section">
          ...
          <div className="form-grid">
            ...
            <Field label="Hardware UUID" help="Match the collector’s GPU UUID. Leave blank only when the provider hides hardware identity."><input disabled={Boolean(record)} maxLength={255} value={draft.hardware_uuid ?? ""} placeholder="GPU-…" onChange={(event) => change("hardware_uuid", event.target.value)} /></Field>
